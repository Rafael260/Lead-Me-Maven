 ...
 * @author rafao
 */
public class LoginUFRNController2 {
                ...
                if (event.getSource() instanceof WebEngine) {
                    ...
                    if (location.startsWith(URL_ENCAMINHA) && location.contains("code")) {
                        try {
                            ...
                            Logger.getLogger(LoginUFRNController2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void carregarAlunoParaService() throws DataException {
        ...
        System.out.println("Número de disciplinas do curso no banco: " + curso.coletarDisciplinas().size());
